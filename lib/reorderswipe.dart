...
class XERList extends StatefulWidget {
  ...
  // Create a forceRedraw int, add down below add a listener to set the state
  // whenever it is incremented.
  ValueNotifier<int> forceRedraw = ValueNotifier<int>(0);
...
class _XERListState extends State<XERList> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.forceRedraw.addListener(() {
      setState(() { });
  });
